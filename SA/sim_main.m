function [assignment, damage_tot, damage_each, dam_tot_unc, dam_each_unc] = sim_main()      %uav_list,ship_list,n_u,n_s,sigma)
...
%% Information Settings
    ...
    ship_position = [      ] ; % 2 column vectrors [Xs,Ys] % position of the ships when they meet uavs [m]
...
%     K_P = ship_spd_model(ship_speed,K_P);
    ...
    % UAV infomation
    uav_position = [    ]; % 2 column vectors [Xs,Ys]
