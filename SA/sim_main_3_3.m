function [assignment, damage_tot, damage_each, dam_tot_unc, dam_each_unc] = sim_main_3_3(n_u)      %uav_list,ship_list,n_u,n_s,sigma)
...
%% Information Settings
    ...
    ship_heading = 0;                          % heading angle of the swarm of ships ranged by [-pi +pi]
...
%     K_P = ship_spd_model(ship_speed,K_P);
    ...
    for i = 1:(mokk+1)
        p_com = p_base;
        p_com(:,1) = (1-i)*100*ones(20,1);
        x_uav = [x_uav; p_com];
    end
    
    uav_position = x_uav(1:n_u,:);
