function [assignment, damage_tot, damage_each, dam_tot_unc, dam_each_unc] = sim_main_3_1(n_u)      %uav_list,ship_list,n_u,n_s,sigma)
...
%% Information Settings
    ...
    ship_position = [4250,700; 4250,-700; 4750,1200; 4750,0; 4750,-1200; 5250,700; 5250,0; 5250,-700; 5750,700; 5750,-700;] ; % 2 column vectrors [Xs,Ys] % position of the ships when they meet uavs [m]
...
%     SL_PSO_navy2;
    ...
    % Classoc PSO implementation
    C_PSO_navy;
    
%     bestp = [9 10 10 7 2 9 8 7 10 2 7 7 5 7 10 7 6 6 6 3 6 9 3 3 6 3 6 6 3 3 1 1 7 2 10 1 1 7 4 1 10 1 1 1 1 10 7 2 2 1 2 5 7 2 10 2 5 8 5 8 5 3 10 8 5 8 5 8 8 10 8 7 9 7 1 9 6 9 10 9];
