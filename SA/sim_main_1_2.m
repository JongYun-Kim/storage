function [assignment, damage_tot, damage_each, dam_tot_unc, dam_each_unc] = sim_main_1_2(n_u,sigma)      %uav_list,ship_list,n_u,n_s,sigma)
...
%     K_P = ship_spd_model(ship_speed,K_P);
    ...
    % UAV infomation
    uav_position = zeros(n_u,2); % 2 column vectors [Xs,Ys]
