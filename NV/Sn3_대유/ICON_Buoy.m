function [hg] = ICON_Buoy(ax,SF,F_color,E_color,N,R,alpha)
...
[THETA,PHI,RR]=cart2sph(V1,V2,V3);
RR=R.*ones(size(V1(:,1)));
[V1,V2,V3]=sph2cart(THETA,PHI,RR);
V=[V1 V2 V3];


h(1) = patch('parent',ax,'Faces',F,'Vertices',V*SF,...
